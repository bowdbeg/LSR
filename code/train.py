...
parser.add_argument(
    ...
    type=int,
    default=False,
    help="Fine tune pre-trained word Embedding.",
)
...
parser.add_argument(
    "--emb_dim", type=int, default=EMB_DIM, help="Word embedding dimension."
)
parser.add_argument(
...
parser.add_argument(
    "--dropout_emb", type=float, default=0.2, help="embedding dropout rate."
)
